...
class NewsarticlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create newsarticle" do
    assert_difference("Newsarticle.count") do
      post newsarticles_url, params: { newsarticle: { articlelink: @newsarticle.articlelink, author: @newsarticle.author, imglink: @newsarticle.imglink, source: @newsarticle.source, text: @newsarticle.text, title: @newsarticle.title } }
    end
  ...
  test "should update newsarticle" do
    patch newsarticle_url(@newsarticle), params: { newsarticle: { articlelink: @newsarticle.articlelink, author: @newsarticle.author, imglink: @newsarticle.imglink, source: @newsarticle.source, text: @newsarticle.text, title: @newsarticle.title } }
